...
def download(book_page_url):
    print("Downloading pdf on the page", book_page_url)
    try:
...
if __name__ == '__main__':
    ...
    """"Scrape pdf from indianculture.gov.in

        Example usage:
        python indianculture.py https://indianculture.gov.in/reports-proceedings/report-village-and-cottage-industries-national-committee-development-backward
    """
    )
    parser.add_argument(
        'book_page_url',
